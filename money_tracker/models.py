...
class Transaction(models.Model):
    ...
    user_category = models.ForeignKey('money_tracker.UserCategory', related_name='transactions', on_delete=models.CASCADE,
                                      verbose_name=_('User category'), null=True, blank=True)
    ...
    def __str__(self):
        if self.category:
            ...
            return f'{self.user_category} - {self.user} - {self.amount}({self.date})'
